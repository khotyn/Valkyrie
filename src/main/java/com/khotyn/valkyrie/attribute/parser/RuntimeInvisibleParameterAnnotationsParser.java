...
import com.khotyn.valkyrie.attribute.RuntimeInvisibleParameterAnnotations;

/**
 * Parser to parse {@link RuntimeInvisibleParameterAnnotations}
 * 
 * @author khotyn
 * 
 */
public class RuntimeInvisibleParameterAnnotationsParser extends AttributeParser {
     ...
     * @param cursor
     */
    public RuntimeInvisibleParameterAnnotationsParser(Clazz clazz, Cursor cursor) {
        super(clazz, cursor);
    }

    @Override
    public Attribute parse() throws Exception {
        RuntimeInvisibleParameterAnnotations result = new RuntimeInvisibleParameterAnnotations();
